package com.vidiun.commands.metadataBatch
{
	...
	import com.vidiun.delegates.metadataBatch.MetadataBatchGetExclusiveJobsDelegate;
	import com.vidiun.net.VidiunCall;

	public class MetadataBatchGetExclusiveJobs extends VidiunCall
	{
		public var filterFields : String;
		public function MetadataBatchGetExclusiveJobs( lockKey : VidiunExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : VidiunBatchJobFilter=null,jobType : int )
		{
