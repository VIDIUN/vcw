...
package com.vidiun.contributionWizard.command
{
	...
	import com.vidiun.contributionWizard.events.shell.WizardShellEvent;
	import com.vidiun.contributionWizard.model.ExternalFunctionIds;
		...
		public override function execute(event:CairngormEvent):void
		{
			...
			switch (notifyShellEvent.type)
			{
				...
				case NotifyShellEvent.PENDING:
					_externalFunctionToCall = _externalFucntionsIds.vcwPendingChangeHandler;
